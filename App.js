...
const App = () => {
  ...
  const shrek = require('./assets/image/shrek.jpg');
  const sexeducation = require('./assets/image/sexeducation.jpg');
  const feliz = require('./assets/image/feliz.jpg');
  const steven = require('./assets/image/steven.jpg');
  const spider = require('./assets/image/spiderverse1.jpg');
...
<View style={styles.container}>
    <Text style={styles.titulo}>Filmes/Series Favoritos:        </Text>
      ...
      <Image source={shrek} style={styles.image} />
      <Text style={styles.sinopse}>
      ...
      <Image source={sexeducation} style={styles.image} />
      <Text style={styles.sinopse}>
